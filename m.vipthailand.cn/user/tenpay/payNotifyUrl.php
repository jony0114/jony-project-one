...
while1("*","fcw_dingdang where ddbh='".$out_trade_no."' and ddzt='等待买家付款'");if($row1=mysql_fetch_array($res1)){
 updatetable("fcw_dingdang","sj='".$sj."',uip='".$userip."',alipayzt='TRADE_SUCCESS',ddzt='交易成功',bz='财付通支付',ifok=1 where id=".$row1[id]." and ddbh='".$out_trade_no."'");
 $money1=$row1["money1"];
 PointIntoM($row1[uid],"财付通充值".$money1."元",$money1);
