...
if(6!=$_SESSION[FCWuserID]){Audit_alert("错误的路径来源！","inf6.php");}
...
if(sqlzhuru($_POST[jvs])=="inf"){
 ...
 if(empty($company) || empty($uadd) || empty($nc)){Audit_alert("错误的路径来源！","inf6.php");}
 ...
 uploadtpnodata(1,"upload/".$userid."/","shop.jpg","allpic",200,200,0,0,"no");
 uploadtpnodata(2,"upload/".$userid."/","bannar.jpg","allpic",1000,0,0,0,"no");
...
$shophf="../upload/".$userid."/bannar.jpg";
?>
...
<div class="yjcode">
<ul class="dqwz">
<li class="l1">您的位置：<a href="../" class="acy">首页</a> > <a href="./" class="acy">会员中心</a> > 公司基本资料</li>
</ul>
<? include("left.php");?>
<!--RB-->
<div class="right">
 ...
 <? }?>
 <li class="l1"><span class="red" style="font-weight:normal;">*</span> 公司地址：</li>
 <li class="l2"><input type="text" class="inp" size="50" name="tuadd" value="<?=$rowuser[uadd]?>" /></li>
 <li class="l1">公司图片：</li>
 <li class="l2"><input type="file" name="inp1" id="inp1" size="25"> [最佳尺寸：200*200]</li>
 <? if(is_file($shoptx)){?>
 <li class="l5"></li>
 <li class="l6"><img width="100" height="100" src="<?=$shoptx?>" /></li>
 <? }?>
 <li class="l1">店铺横幅：</li>
 <li class="l2"><input type="file" name="inp2" id="inp2" size="25"> [最佳尺寸：1100宽，高不限]</li>
 <? if(is_file($shophf)){?>
 <li class="l5"></li>
 <li class="l6"><a href="<?=$shophf?>" target="_blank"><img width="100" height="30" src="<?=$shophf?>" border="0" /></a></li>
 <? }?>
 <li class="l7">公司描述：</li>
