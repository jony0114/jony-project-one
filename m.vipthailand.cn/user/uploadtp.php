...
while1("*","fcw_user where id=".$userid." and pwd='".sqlzhuru($_POST[pwd])."'");if(!$row1=mysql_fetch_array($res1)){echo "1";exit;}
while1("*","fcw_fang where bh='".$bh."' and uid='".$row1[uid]."'");if(!$row1=mysql_fetch_array($res1)){echo "1";exit;}
