...
if(sqlzhuru($_POST[jvs])=="inf"){
 ...
 if(empty($company) || empty($uadd) || empty($nc)){Audit_alert("错误的路径来源！","inf3.php");}
...
<div class="right">
 ...
 <li class="l1">地图坐标：</li>
 <li class="l2">
 <input type="text" value="<?=$rowuser[zb]?>" class="inp" name="tzb" onfocus="inpf(this)" onblur="inpb(this)" /> 
 [<a href="http://api.map.baidu.com/lbsapi/getpoint/index.html" target="_blank">点击获取</a>]
 </li>
 <li class="l1">坐标缩放等级：</li>
 <li class="l2"><input type="text" value="<?=returnjgdw($rowuser[zbdj],"",15)?>" class="inp" name="tzbdj" onfocus="inpf(this)" onblur="inpb(this)" /></li>
 <li class="l7">公司描述：</li>
