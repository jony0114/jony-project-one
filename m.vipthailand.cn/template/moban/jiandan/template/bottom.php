...
客服热线：<?=webtel?>（周一至周五：8:00-7:00） <a href="http://www.miitbeian.gov.cn/" target="_blank"><?=$rowcontrol[beian]?></a> <?=$rowcontrol[webtongji]?>
</li>
<li class="l2"><a href="<?=weburl?>"><img border="0" src="<?=weburl?>img/logo.png"  /></a></li>
</ul>
</div>
</div>
<!--B E-->
