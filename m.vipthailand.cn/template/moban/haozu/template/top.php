...
<div class="topbfb">
 <div class="yjcode">
  ...
  <ul class="u1">
  <li class="l1">
  <input type="text" name="t1" data-tip="请输入小区名称" placeholder="请输入小区名称" id="tsearcht1" autocomplete="off" disableautocomplete>
  <div id="tsearchHtml" style="display:none;"></div>
  </li>
  <li class="l2"><input type="submit" class="fontyh" value="开始找房" /></li>
  <li class="l3"><a href="<?=weburl?>map/index.php?xs=xq" target="_blank">地图找房</a></li>
  </ul>
  </form>
  </div>
