...
<div class="right">
 ...
 <?
 $adbh=array("ADDL","ADI00","ADI01","ADI07","ADI12","pu_01","pu_02","pu_03","ADI05","ADKF");
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","首页友情链接","首页资讯上方横幅","行业找店铺右侧","求租求购上方","按照行业找店铺上方","顶部文字广告","右侧自定义客服");
 $adsize=array("100*280","1200*?","1200*?","","1200*?","326*202","428*85","1200*?","","");
 $admust=array("pic","pic","","font","","","","","","font","code");
