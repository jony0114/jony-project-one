...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="wytslist.php">物业特色</a>
 </div>

 <!--begin-->
 <ul class="ksedi">
 <li class="l2">
 <a href="wyts.php" class="a1">新增特色</a>
 <a href="javascript:void(0)" onclick="checkDEL(13,'fcw_wyts')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 <li class="l1"><input name="C2" type="checkbox" onclick="xuan()" /></li>
 <li class="l2">物业特色列表</li>
 <li class="l3">序号</li>
 <li class="l4">编辑时间</li>
 <li class="l5">操作</li>
 </ul>
 <?
 while1("*","fcw_wyts order by xh asc");while($row1=mysql_fetch_array($res1)){
 $nu="wyts.php?action=update&id=".$row1[id];
 ?>
 <ul class="qjlist2">
