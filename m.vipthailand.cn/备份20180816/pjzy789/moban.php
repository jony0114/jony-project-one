...
<div class="right">
 ...
 <? $i=0;foreach(getDir("../template/moban/") as $color){if(is_file("../template/moban/".$color."/homeimg/moban_small.jpg")){?>
  <div class="d1" onmouseover="this.className='d1 d11';" onmouseout="this.className='d1';"><? if($rowcontrol[nowmb]==$color){?><span class="s1">当前模板</span><? }?><a href="../template/moban/<?=$color?>/homeimg/moban_big.jpg" target="_blank"><img border="0" src="../template/moban/<?=$color?>/homeimg/moban_small.jpg" width="120" height="120" /></a><br><?=$color?><br><a href="javascript:void(0);" onclick="mbcha('<?=$color?>')" class="a1">【点击启用】</a></div>
 <? $i++;}}?>
 </div>
 <script language="javascript">
