...
if($_GET[control]=="add"){
 ...
 {Audit_alert("该分组已存在！","jiaphototype3.php?ty1id=".$ty1id."&ty2id=".$ty2id);}
 ...
 {Audit_alert("该分组已存在！","jiaphototype3.php?action=update&id=".$_GET[id]."&ty1id=".$ty1id."&ty2id=".$ty2id);}
...
<div class="right">
 ...
 <? if($_GET[t]=="suc"){systs("恭喜您，操作成功！","jiaphototype3.php?action=".$_GET[action]."&ty1id=".$ty1id."&ty2id=".$ty2id."&id=".$_GET[id]);}?>
 ...
 <li class="l1">排序：</li>
 <li class="l2"><input type="text" class="inp" name="t2" value="<?=returnxh("fcw_jia_phototype"," and type1='".$ty1name."'  and type2='".$ty2name."' and admin=3")?>" /> <span class="fd">序号越小，越靠前</span></li>
