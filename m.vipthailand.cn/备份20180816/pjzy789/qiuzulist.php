...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="qiuzulist.php">求租管理</a>
 </div>
 <!--B-->
 <ul class="psel">
 ...
 <li class="l3"><strong class="feng"><?=returnqiu($row[money1],$row[money2],"元")?></strong></li>
 <li class="l4"><?=$row[djl]?></li>
 <li class="l5"><?=$row[sj]?></li>
 <li class="l6"><a href="<?=$aurl?>" class="a1">修改</a><span></span><a href="../qiuzu/view<?=$row[id]?>.html" target="_blank" class="a1">预览</a>
 </li>
 </ul>
 <? }?>
 <?
