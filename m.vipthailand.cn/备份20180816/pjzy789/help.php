...
<div class="right">
 ...
 <div class="rkuang">
 <?
 while0("*","fcw_help where bh='".$bh."'");if(!$row=mysql_fetch_array($res)){php_toheader("helplist.php");}
 ?>
 <script language="javascript">
 function tj(){
 ...
 <? while1("*","fcw_helptype where admin=1");while($row1=mysql_fetch_array($res1)){?>
 ...
 <? while2("*","fcw_helptype where admin=2 and name1='".$row1[name1]."'");while($row2=mysql_fetch_array($res2)){?>
