...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="gongjiaolist.php">公交管理</a>
 </div>

 <!--begin-->
 <ul class="ksedi">
 <li class="l2">
 <a href="gongjiao.php" class="a1">新增公交</a>
 <a href="javascript:void(0)" onclick="checkDEL(39,'fcw_gongjiao')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 $nu="gongjiao.php?action=update&id=".$row1[id];
 ?>
 <ul class="qjlist2">
