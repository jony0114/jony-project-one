...
if($_GET[control]=="update"){
 ...
 uploadtpnodata(1,"upload/news/".$bh."/","xgt.jpg","allpic",750,400,0,0,"no");
 php_toheader("fxtg.php?t=suc&action=update&bh=".$bh);
...
<div class="right">
 ...
 <? if($_GET[t]=="suc"){systs("恭喜您，操作成功！[<a href='fxtglx.php'>继续添加新信息</a>]","fxtg.php?bh=".$bh);}?>
 
 <div class="bqu1">
 <a href="javascript:void(0);" class="a1">发现泰国信息</a>
 <a href="fxtglist.php">返回列表</a>
 </div> 

 <!--B-->
 <div class="rkuang">
 <? while0("*","fcw_fxtg where bh='".$bh."'");if(!$row=mysql_fetch_array($res)){php_toheader("fxtglist.php");}?>
 <script language="javascript">
 function tj(){
 ...
 f1.action="fxtg.php?bh=<?=$bh?>&control=update";
 }
 </script>
 ...
 <li class="l4">简要主题：</li>
 <li class="l5"><textarea name="ttit1"><?=$row[tit1]?></textarea></li>
 <li class="l1"><span class="red">*</span> 所属分类：</li>
 <li class="l2">
 <select name="d1" class="inp1">
 <option value="1">旅游线路</option>
 <option value="2">吃喝玩乐</option>
 <option value="3">泰国文化</option>
 </select>
 </li>
 <li class="l1">效果图：</li>
 <li class="l2"><input type="file" class="inp1" name="inp1" id="inp1" size="15" accept=".jpg,.gif,.jpeg,.png"> <span class="fd">最佳尺寸：750*400</span></li>
 <li class="l8"></li>
