...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="chuzulist.php">出租管理</a>
 </div>
 ...
 <a href="javascript:void(0)" onclick="checkDEL(80,'fcw_fang')" class="a2">更新全部</a>
 ...
 <a href="chuzulist.php?zt=1" class="a2">需要审核</a>
 </li>
 </ul>
 ...
 <li class="l3"><strong class="feng"><?=returnjgdw($row[money1],$row[jgdw])?></strong></li>
 <li class="l4"><?=$row[djl]?></li>
 <li class="l5"><strong><? if($row[zddq]>$sj){echo " 置顶 ";} if($row[jsdq]>$sj){echo " 急租 ";}?></strong></li>
 <li class="l6">
 <a href="<?=$aurl?>" class="a1">修改</a><span></span>
 <a href="../rent/view<?=$row[id]?>.html" target="_blank" class="a1">预览</a>
 </li>
 </ul>
 <? }?>
 <?
