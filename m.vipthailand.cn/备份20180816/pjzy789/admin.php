...
if($_GET[control]=="add"){
 ...
 if(panduan("adminuid","fcw_admin where adminuid='".sqlzhuru($_POST[t1])."'")==1){Audit_alert("该管理员帐号已经存在！","admin.php");}
 ...
 if(!strstr($adminqx,",0,")){Audit_alert("权限不够！","default.php");}
 if(panduan("id,adminuid","fcw_admin where adminuid='".sqlzhuru($_POST[t1])."' and id<>".$_GET[id])==1){Audit_alert("该管理员帐号已经存在！","admin.php?action=update&id=".$_GET[id]);}
 if(strstr($_GET[qx],",0,")){$qxv=",0,";}else{$qxv=$_GET[qx];}
...
<div class="right">
 ...
 <div class="bqu1">
 <a href="javascript:void(0);" class="a1">管理员信息</a>
 ...
 <li class="l1">新密码：</li>
 <li class="l2"><input type="password" class="inp" name="t2" size="20" /><span class="fd">留空表示不修改</span></li>
