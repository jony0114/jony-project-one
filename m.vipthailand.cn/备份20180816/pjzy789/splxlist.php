...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="splxlist.php">商铺类型</a>
 </div>

 <!--begin-->
 <ul class="ksedi">
 <li class="l2">
 <a href="splx.php" class="a1">新增类型</a>
 <a href="javascript:void(0)" onclick="checkDEL(6,'fcw_splx')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 <li class="l1"><input name="C2" type="checkbox" onclick="xuan()" /></li>
 <li class="l2">商铺类型列表</li>
 <li class="l3">序号</li>
 <li class="l4">编辑时间</li>
 <li class="l5">操作</li>
 </ul>
 ...
 $nu="splx.php?action=update&id=".$row1[id];
 ?>
 <ul class="qjlist2">
