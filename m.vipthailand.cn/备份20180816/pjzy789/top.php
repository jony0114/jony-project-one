...
<div class="bfbtop">
 ...
 <? if(strstr($adminqx,",0,") || strstr($adminqx,",0202,")){?><a id="menu3" href="newslist.php"><img src="img/tm3.png" /><br>资讯管理</a><? }?>
 <? if(strstr($adminqx,",0,") || strstr($adminqx,",0402,") || strstr($adminqx,",0502,")){?><a id="menu5" href="loupanlist.php"><img src="img/tm5.png" /><br>楼盘管理</a><? }?>
 <? if(strstr($adminqx,",0,") || strstr($adminqx,",0602,")){?><a id="menu6" href="adtypeMT.php"><img src="img/tm6.png" /><br>广告互动</a><? }?>
 </div>
