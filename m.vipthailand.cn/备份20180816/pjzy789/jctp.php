...
AdminSes_audit();
$bh=$_GET[bh];
while0("*","fcw_jia_jc where bh='".$bh."'");if(!$row=mysql_fetch_array($res)){php_toheader("./");}

if($_GET[control]=="update"){
 updatetable("fcw_tp","xh=".$_GET[xh]." where id=".$_GET[id]);
 php_toheader("jctp.php?t=suc&bh=".$bh);
}
?>
...
function xhonc(x){
location.href="jctp.php?id="+x+"&bh=<?=$bh?>&control=update&xh="+document.getElementById("xh"+x).value;
}
</script>
</head>
<body>
...
<div class="right" id="right">
 <ul class="wz"><li class="l1">当前位置：<a href="./" class="a2">后台首页</a> - <strong>建材商品图片管理</strong></li><li class="l2"></li></ul>
 <? if($_GET[t]=="suc"){systs("恭喜您，操作成功","jctp.php?bh=".$bh);}?>
 <!--B-->
 <div class="listkuan">
 <ul class="fangtpcap">
