...
<div class="right">
 ...
 <?
 $adbh=array("ADN00","ADNV01","ADNV02","ADNV03","ADNV04","ADN01");
 $adtit=array("资讯首页切换","资讯详情页宽横幅","资讯摘要内容上方横幅","资讯首页/列表/详情右侧广告","资讯详情页最新发布上方","资讯首页头条下方横幅");
 $adsize=array("290*200","1100*?","790*?","290*?","790*?","788*?");
 $admust=array("pic","","","","");
