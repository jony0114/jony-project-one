...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="jiajctype1.php" class="a1">新增分类</a>
 <a href="javascript:void(0)" onclick="checkDEL(56,'fcw_jia_jctype')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 <li class="l1"><input name="C2" type="checkbox" onclick="xuan()" /></li>
 <li class="l2">建材大分类</li>
 <li class="l3">序号</li>
 <li class="l4">编辑时间</li>
 <li class="l5">操作</li>
 </ul>
 ...
 <li class="l5">
 <a href="jiajctype2.php?ty1id=<?=$row1[id]?>">添加子类</a><span></span>
 <a href="<?=$nu?>">编辑</a></li>
 </ul>
 <? }?>
 <!--end-->
