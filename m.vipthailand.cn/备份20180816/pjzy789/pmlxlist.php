...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="pmlxlist.php">铺面类型</a>
 </div>

 <!--begin-->
 <ul class="ksedi">
 <li class="l2">
 <a href="pmlx.php" class="a1">新增类型</a>
 <a href="javascript:void(0)" onclick="checkDEL(7,'fcw_pmlx')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 $nu="pmlx.php?action=update&id=".$row1[id];
 ?>
 <ul class="qjlist2">
