...
$sql="select * from fcw_dingdang where ddbh='".$ddbh."'";mysql_query("SET NAMES 'GBK'");$res=mysql_query($sql);
...
updatetable("fcw_dingdang","wxddbh='".$wxddbh."' where ddbh='".$ddbh."'");
?>
...
function updatePage() {
  if (xmlHttp.readyState == 4) {
	...
	if(response=="ok"){parent.location.href="../../paylog.php";}else{setTimeout("yzonc()",2000);return false;}
  }
}
...
<body>
<img src="../img/clo.gif" style="float:right;cursor:pointer;" onClick="javascript:parent.bgwxonc(0);" width="52" height="22">
<img alt="模式二扫码支付" style="float:left;clear:both;margin:0 0 0 7px;" src="<?=weburl?>template/getqr.php?u=<?=urlencode($url2)?>&size=9"/>
<br><br>
