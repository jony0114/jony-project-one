...
while1("bh,xqbh,sj","fcw_xqnews where bh='".$bh."' and uid='".$_SESSION[FCWuser]."'");if(!$row1=mysql_fetch_array($res1)){exit;}
...
$tplj1="upload/".$userid."/f/".$row1[xqbh]."/".$bh."/";
 ...
 php_toheader("lpnewsupload.php?bh=".$bh."&tpbh=".$nbh."&clearid=".$clearid);
  ...
  if(panduan("uid,bh","fcw_xqnews where uid='".$_SESSION[FCWuser]."' and bh='".$_GET[bh]."'")==1){
