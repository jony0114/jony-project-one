...
.inp1{float:left;border:#CCCCCC solid 1px;height:33px;padding:0 0 0 5px;font-size:14px;font-family:"Microsoft YaHei",微软雅黑,"MicrosoftJhengHei",华文细黑,STHeiti,MingLiu;}
</style>
</head>
<body>
<? if(!empty($ty1id)){?>
<select name="da" id="da" class="inp1" style="display:none;" onChange="sphy2cha()">
...
<? if($ejh==0){?>parent.document.getElementById("fhylx2").style.display="none";<? }else{?>document.getElementById("da").style.display="";<? }?>
