...
<div class="right">
 ...
 <?
 $adbh=array("ADDL","ADI07","ADI08","ADI10","ADI12","ADI14","ADI15","jia_01","ADKF");
 $adtit=array("对联广告","首页友情链接","首页楼盘上方横幅","首页买房团上方横幅","首页资讯上方横幅","首页二手房上方横幅","首页租房上方横幅","首页大图","右侧自定义客服");
 $adsize=array("100*?","","1200*?","1200*?","1200*?","1200*?","1200*?","1920*583","");
 $admust=array("pic","font","","","","","","pic","code");
