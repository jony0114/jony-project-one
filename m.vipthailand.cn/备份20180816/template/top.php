...
<div class="topbfb">
 ...
 <div class="logo"><? include("fzqh.php");?></div>
 <!--搜B-->
 <form name="topf" method="post" onsubmit="return topser()">
 <ul class="topus">
 <li class="l1">
 <a href="<?=weburl?>loupan/" id="topa1" onmouseover="topaover(1,'loupan','','search')">新楼盘</a>
 <a href="<?=weburl?>second/" id="topa2" onmouseover="topaover(2,'second','','search')">二手房</a>
 <a href="<?=weburl?>rent/" id="topa3" onmouseover="topaover(3,'rent','','search')">租房</a>
 <? $xzlid=returnwylx(2,"写字楼");?><a href="<?=weburl?>second/search_f<?=$xzlid?>v.html" id="topa4" onmouseover="topaover(4,'second','_f<?=$xzlid?>v','search')">写字楼</a>
 <? $spid=returnwylx(2,"商铺");?><a href="<?=weburl?>second/search_f<?=$spid?>v.html" id="topa5" onmouseover="topaover(5,'second','_f<?=$spid?>v','search')">商铺</a>
 <a href="<?=weburl?>news/" id="topa6" onmouseover="topaover(6,'news','','newslist')">资讯</a>
 </li>
 <li class="l2"><input type="text" name="topsert" /></li>
 <li class="l3"><input type="image" src="<?=weburl?>img/search.gif" width="59" height="34" /></li>
 </ul>
 </form>
 <!--搜E-->
 <a href="<?=weburl?>user/fb.php"><img class="topfb" src="<?=weburl?>img/btn6.gif" width="155" height="40" border="0" /></a>
 <div class="mtmap">
