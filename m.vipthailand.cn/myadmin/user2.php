...
if($_GET[control]=="update"){
 ...
 if(empty($nc)){Audit_alert("错误的路径来源！","user2.php");}
 ...
 uploadtpnodata(2,"upload/".$id."/","wx.jpg","allpic",200,200,0,0,"no");
 php_toheader("user2.php?t=suc&id=".$id);
...
function tj(){
 ...
 f1.action="user2.php?control=update&id=<?=$id?>&qx="+str+"&ife="+ife+"&ifm="+ifm;
}
</script>
</head>
<body>
...
<div class="right">
 <? if($_GET[t]=="suc"){systs("恭喜您，操作成功！","user2.php?id=".$id);}?>
 ...
 <? if(is_file($wx)){?>
 <li class="l8"></li>
 <li class="l9"><img src="<?=$wx?>" width="54" height="54" /></li>
 <? }?>
 <? if(empty($row[zjuid])){?>
 <li class="l1">所在区域：</li>
 <li class="l2">
 ...
 <li class="l1">具体地址：</li>
 <li class="l21">
 <?=returnarea(1,$row1[areaid])." ".returnarea(2,$row1[areaids])." ".$row1[uadd]?>
 </li>
