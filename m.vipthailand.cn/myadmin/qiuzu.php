...
AdminSes_audit();
$bh=$_GET[bh];
while0("*","fcw_fang where bh='".$bh."' and type1='求租'");
...
if($_GET[control]=="update" && $_POST[jvs]=="qiuzu"){
 ...
 php_toheader("qiuzu.php?t=suc&bh=".$bh);
...
<div class="yjcode">
 <? $leftid=4;include("menu_fang.php");?>

<div class="right">
 
 <? if($_GET[t]=="suc"){systs("恭喜您，操作成功！","qiuzu.php?bh=".$_GET[bh]);}?>
 
 <div class="bqu1">
 <a href="javascript:void(0);" class="a1">求租信息</a>
 <a href="qiuzulist.php">返回列表</a>
 </div> 
