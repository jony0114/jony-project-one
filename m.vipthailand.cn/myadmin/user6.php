...
if($_GET[control]=="update"){
 ...
 if(empty($company) || empty($uadd) || empty($nc)){Audit_alert("错误的路径来源！","user6.php");}
 ...
 uploadtpnodata(1,"upload/".$id."/","shop.jpg","allpic",200,200,0,0,"no");
 php_toheader("user6.php?t=suc&id=".$id);
...
function tj(){
 ...
 f1.action="user6.php?control=update&id=<?=$id?>&qx="+str+"&ife="+ife+"&ifm="+ifm;
}
</script>
</head>
<body>
...
<div class="right">
 <? if($_GET[t]=="suc"){systs("恭喜您，操作成功！","user6.php?id=".$id);}?>
