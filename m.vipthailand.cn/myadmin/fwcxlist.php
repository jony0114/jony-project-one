...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="fwcxlist.php">房屋朝向</a>
 </div>

 <!--begin-->
 <ul class="ksedi">
 <li class="l2">
 <a href="fwcx.php" class="a1">新增朝向</a>
 <a href="javascript:void(0)" onclick="checkDEL(3,'fcw_fwcx')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 <li class="l1"><input name="C2" type="checkbox" onclick="xuan()" /></li>
 <li class="l2">房屋朝向列表</li>
 <li class="l3">序号</li>
 <li class="l4">编辑时间</li>
 <li class="l5">操作</li>
 </ul>
 ...
 $nu="fwcx.php?action=update&id=".$row1[id];
 ?>
 <ul class="qjlist2">
