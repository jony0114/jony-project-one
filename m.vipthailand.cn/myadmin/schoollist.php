...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="schoollist.php">学校管理</a>
 </div>

 <!--begin-->
 <ul class="ksedi">
 <li class="l2">
 <a href="school.php" class="a1">新增学校</a>
 <a href="javascript:void(0)" onclick="checkDEL(67,'fcw_school')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 <?
 while1("*","fcw_school where admin=1 order by xh asc");while($row1=mysql_fetch_array($res1)){
 $nu="school.php?action=update&id=".$row1[id];
 ?>
 <ul class="qjlist1">
 ...
 <a class="add" href="school1.php?ty1id=<?=$row1[id]?>">添加子类</a><span></span>
 ...
 $nu="school1.php?action=update&id=".$row2[id]."&ty1id=".$row1[id]; 
 ?>
 <ul class="qjlist2">
