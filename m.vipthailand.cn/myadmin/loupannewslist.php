...
<div class="right">
 ...
 <a href="javascript:void(0)" onclick="checkDEL(24,'fcw_xqnews')" class="a2">变更审核</a>
 <a href="javascript:void(0)" onclick="checkDEL(25,'fcw_xqnews')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="lplcap">
 <li class="l1"><input name="C2" type="checkbox" onclick="xuan()" /></li>
 <li class="l2">楼盘动态信息</li>
 <li class="l3">审核</li>
 <li class="l4">关注</li>
 <li class="l5">时间</li>
 <li class="l6">操作</li>
 ...
 <?
 pagef($ses,20,"fcw_xqnews","order by sj desc");while($row=mysql_fetch_array($res)){
 ...
 <li class="l6"><a href="<?=$aurl?>">修改</a><span></span><a href="../loupan/newsview<?=$row[id]?>.html" target="_blank">预览</a></li>
 </ul>
 <? }?>
 <?
