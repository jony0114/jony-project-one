...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="newstypelist.php">资讯分类管理</a>
 </div>
 ...
 <a href="javascript:void(0)" onclick="checkDEL(9,'fcw_newstype')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 <?
 while1("*","fcw_newstype where admin=1 order by xh asc");while($row1=mysql_fetch_array($res1)){
 ...
 <a class="add" href="newstype1.php?ty1id=<?=$row1[id]?>">添加子类</a><span></span>
 <a class="edi" href="<?=$nu?>">修改信息</a>
 </li>
 </ul>
 <?
 while2("*","fcw_newstype where admin=2 and name1='".$row1[name1]."' order by xh asc");while($row2=mysql_fetch_array($res2)){
