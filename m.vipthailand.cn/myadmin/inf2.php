...
<div class="right">
 ...
 <label><input name="Rsmsmode" onclick="smsmdcha(1)" type="radio" value="1" <? if($row[smsmode]==1){?> checked="checked"<? }?> />模板发送形式（阿里大于）<a href="http://www.yj99.cn/faq/view93.html" target="_blank" class="red">查看配置说明</a></label>&nbsp;&nbsp;
 <label><input name="Rsmsmode" onclick="smsmdcha(2)" type="radio" value="2" <? if($row[smsmode]==2){?> checked="checked"<? }?> />模板发送形式（阿里通信）<a href="http://www.yj99.cn/faq/view93.html" target="_blank" class="red">配置说明</a></label>
 </span>
 </li>
 </ul>
 ...
 <? 
 $nbh="001";
 $t="验证码：\${yzm}，您正在进行手机验证，如果不是本人操作，请忽略此信息。";
 ...
 <? 
 $nbh="002";
 $t="验证码：\${yzm}，您正在使用手机号码快速登录，如果不是本人操作，请忽略此信息。";
 while1("*","fcw_smsmb where mybh='".$nbh."'");if($row1=mysql_fetch_array($res1)){$mbid=$row1[mbid];$txt=$row[txt];}else{
 intotable("fcw_smsmb","mybh,txt,mbid","'".$nbh."','".$t."',''");$txt=$t;$mbid="";
 }
 ?>
 ...
 <? 
 $nbh="006";
 $t="验证码：\${yzm}，您正在进行委托发布，如非本人操作，请忽略本信息。";
 while1("*","fcw_smsmb where mybh='".$nbh."'");if($row1=mysql_fetch_array($res1)){$mbid=$row1[mbid];$txt=$row[txt];}else{
 intotable("fcw_smsmb","mybh,txt,mbid","'".$nbh."','".$t."',''");$txt=$t;$mbid="";
 }
 ?>
 ...
 <span class="fd"><a href="http://www.yj99.cn/faq/view105.html" class="red" target="_blank">[查看教程]</a></span>
 </li>
