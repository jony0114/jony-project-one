...
function ser(){
location.href="loupanlist.php?st1="+document.getElementById("st1").value+"&zt="+document.getElementById("zt").value;	
}
</script>
</head>
<body>
...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="loupanlist.php">楼盘管理</a>
 </div>
 ...
 <a href="../m/xmview<?=$row[id]?>.html" target="_blank" class="a1">预览</a>
 </li>
 </ul>
 <? }?>
 <?
