...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="helptypelist.php">帮助分类管理</a>
 </div>
 ...
 <a href="javascript:void(0)" onclick="checkDEL(8,'fcw_helptype')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 <?
 while2("*","fcw_helptype where admin=2 and name1='".$row1[name1]."' order by xh asc");while($row2=mysql_fetch_array($res2)){
