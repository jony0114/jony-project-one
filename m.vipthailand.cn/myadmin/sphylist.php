...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="sphylist.php">商铺行业管理</a>
 </div>

 <!--begin-->
 <ul class="ksedi">
 <li class="l2">
 <a href="sphy.php" class="a1">新增行业</a>
 <a href="javascript:void(0)" onclick="checkDEL(77,'fcw_sphy')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 $nu="sphy.php?action=update&id=".$row1[id];
 ?>
 <ul class="qjlist1">
 ...
 <a class="add" href="sphy1.php?ty1id=<?=$row1[id]?>">添加子类</a><span></span>
 <a class="edi" href="<?=$nu?>">修改信息</a>
 </li>
 </ul>
 <?
 while2("*","fcw_sphy where admin=2 and name1='".$row1[name1]."' order by xh asc");while($row2=mysql_fetch_array($res2)){
 $nu="sphy1.php?action=update&id=".$row2[id]."&ty1id=".$row1[id]; 
 ?>
 <ul class="qjlist2">
