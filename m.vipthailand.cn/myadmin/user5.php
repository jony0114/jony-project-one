...
if($_GET[control]=="update"){
 ...
 if(empty($company) || empty($uadd) || empty($nc)){Audit_alert("错误的路径来源！","user5.php");}
 ...
 php_toheader("user5.php?t=suc&id=".$id);
...
function tj(){
 ...
 f1.action="user5.php?control=update&id=<?=$id?>&qx="+str+"&ife="+ife+"&ifm="+ifm;
}
</script>
</head>
<body>
...
<div class="right">
 <? if($_GET[t]=="suc"){systs("恭喜您，操作成功！","user5.php?id=".$id);}?>
 ...
 <label><input name="C1" type="checkbox" value="9"<? if(strstr($row[qx],",9,")){?> checked="checked"<? }?>/> 楼盘管理</label>
 </li>
 <li class="l1">推广排序：</li>
